...
import (
	...
	types "github.com/Exca-DK/HoudiniPrometheus/services/viewportActivity"
)
...
func (s *Set) BindService(service core.Service) {
	s.PostEndpoint = core.MakeEndpointType(service, reflect.TypeOf(types.ViewportPostRequest{}), core.POST, []core.RestrictionHandler{internal.ValidateRequest})
